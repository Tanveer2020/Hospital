...
<div align="center" style="padding:70px;">
	...
	<table>
       ...
       <tr style="background-color:black;" align="center">
        ...
        <td style ="padding: 10px;  color:white;">{{$appoint->date}}v</td>
        <td style ="padding: 10px;  color:white;">{{$appoint->message}}</td>
        <td style ="padding: 10px;  color:white;">{{$appoint->status}}</td> 
        <td><a class="btn btn-danger" onclick="return confirm('Are You sure to delete this')" href="{{url('cancel_appoint',$appoint->id)}}">Cancel</td>
       </tr>
